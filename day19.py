...
def CheckBuiltable(blueprint,Robots,Resources):
    ...
    if not maxResource[1] and Resources[0] // blueprint[1] > 0:
        BuiltRobots.append([0,1,0,0])
        UsedResources.append([blueprint[1],0,0,0])
    if not maxResource[0] and Resources[0] // blueprint[0] > 0:
        BuiltRobots.append([1,0,0,0])
        UsedResources.append([blueprint[0],0,0,0])
    if len(BuiltRobots) == 0 or (Resources[0] < blueprint[0] * 2 and Resources[0] < blueprint[1] * 2):
